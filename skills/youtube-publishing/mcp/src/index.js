...
async function callGateway(name, a, env) {
  ...
  const routes = {
    ...
    youtube_search: dataApi("search", "list", { part: "snippet", q: a.q, type: a.type || "video", order: a.order || "relevance", maxResults: a.max_results || 25, regionCode: a.region_code, relevanceLanguage: a.relevance_language, publishedAfter: a.published_after, publishedBefore: a.published_before, pageToken: a.page_token, safeSearch: a.safe_search }),
